...
// ISO 4217
const CURRENCIES = {
  ALL: { num: '008', decimals: 2 },
  DZD: { num: '012', decimals: 2 },
  //AOK: { num: '024', decimals: },
  //MON: { num: '030', decimals: },
  //AZM: { num: '031', decimals: },
  // Redsys says 032 is ARP, but that currency code is no longer used
  ARS: { num: '032', decimals: 2 },
  AUD: { num: '036', decimals: 2 },
  BSD: { num: '044', decimals: 2 },
  BHD: { num: '048', decimals: 3 },
  BDT: { num: '050', decimals: 2 },
  AMD: { num: '051', decimals: 2 },
  BBD: { num: '052', decimals: 2 },
  BMD: { num: '060', decimals: 2 },
  BTN: { num: '064', decimals: 2 },
  // Redsys says 068 is BOP, but that currency code is no longer used
  BOB: { num: '068', decimals: 2 },
  //BAD: { num: '070', decimals: },
  BWP: { num: '072', decimals: 2 },
  //BRC: { num: '076', decimals: },
  BZD: { num: '084', decimals: 2 },
  SBD: { num: '090', decimals: 2 },
  BND: { num: '096', decimals: 2 },
