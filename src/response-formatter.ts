...
type ResponseFormatter = (obj: FormattedResponse, value: string) => void;

export const responseFormatters: Record<string, ResponseFormatter> = {
...
export const formatResponse = (rawParams: RawResponseParams): FormattedResponse => {
