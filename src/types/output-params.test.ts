...
import type { deserializedSoapNotification } from '../../test/fixtures/soap/redirect-notification';
...
describe('RestTrataPeticionOutputParams', () => {
  it('should match real data', () => {
    expectType<
      TypeOf<RestTrataPeticionOutputParams, typeof deserializedRestJsonResponse>
    >(true);
