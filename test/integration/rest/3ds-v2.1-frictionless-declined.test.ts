...
import { threeDSv21FrictionlessDeclined } from '../../fixtures/cards';
import {
  createRedsysAPI,
  TRANSACTION_TYPES,
  randomTransactionId,
...
const {
  ...
  merchantData,
  card
} = threeDSv21FrictionlessDeclined;
...
describe('Rest 3DS v2.1 frictionless, declined', () => {
  ...
  it('should send 3DS auth data and have transaction declined', async () => {
    assertEMV3DSv2WithMethodCardConfig(infoResult);
