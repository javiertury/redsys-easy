...
import { threeDSv21ChallengeDeclined } from '../../fixtures/cards';
import {
  createRedsysAPI,
  TRANSACTION_TYPES,
  randomTransactionId,
...
describe('Rest 3DS v2.1 challenge, declined', () => {
  ...
  it('should have transaction declined', async () => {
