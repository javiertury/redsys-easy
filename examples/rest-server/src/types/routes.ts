...
interface PreauthRegularTransactionData extends CardData {
  type: 'regular'
}

interface PreauthIdOperTransactionData {
  type: 'id-oper'
...
interface PreauthV1Output {
  /** 3DS version used */
  threeDSProtocolVersion: '1.0.2' | 'none'
}

interface PreauthV22Output {
  /** 3DS version used */
...
export type OrderSummaryOutput = OrderInfo | undefined;
